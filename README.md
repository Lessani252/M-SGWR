...
---------------------
- For installing its Python package, please use this commmand "pip install sgwr" and its usage is shown in this file "M-SGWR Code Implementation.ipynb"
- Please download "SGWR_Model_WINDOWS_0.4_setup.exe" from the above and then follow the installation steps. Once it's installed, you should be able to run SGWR, M-SGWR, GWR, and MGWR models in the GUI tool. 
...
------------------------
An example of comparison between the estimated coefficients and the true coefficients based on the proposed model (M-SGWR) and MGWR model.
